...
vaultFactory
  ...
  .option("-a, --admin <defaultAdmin>", "default admin address")
  .option("-f, --funder <funder>", "funder role address")
  .option("-w, --withdrawer <withdrawer>", "withdrawer role address")
  .option("-m, --mint <minter>", "minter role address")
  .option("-b, --burn <burner>", "burner role address")
  .option("-r, --rebalancer <rebalancer>", "rebalancer role address")
  .option("-p, --pauser <depositPauser>", "depositPauser role address")
  .option("-d, --resumer <depositResumer>", "depositResumer role address")
  .option("-e, --exiter <exitRequester>", "exitRequester role address")
  ...
  .argument("<quantity>", "quantity of vaults to create, default 1")
