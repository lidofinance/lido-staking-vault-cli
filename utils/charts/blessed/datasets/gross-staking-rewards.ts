...
export const buildGrossStakingRewardsChart = (args: BuildChartArgs) => {
  ...
  return {
    ...
    dataset: {
      ...
      label: 'grossStakingRewards',
      x: adaptiveLabels,
      y,
      style: { line: LINE_COLORS.grossStakingRewards },
    },
    bar: {
      data: {
        barCategory: adaptiveLabels,
        y,
      },
    },
  };
