import { dgEmergencyProtectedTimeLockErrorsAbi } from './dgEmergencyProtectedTimeLockErrorsAbi';

export const dgEmergencyProtectedTimeLockAbi = [
  ...dgEmergencyProtectedTimeLockErrorsAbi,
  {
    inputs: [
      {
        components: [
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newAdminExecutor', type: 'address' },
    ],
  ...
  {
    inputs: [
      { internalType: 'Duration', name: 'newAfterSubmitDelay', type: 'uint32' },
    ],
