...
| connect-and-accept-tier connect-and-accept\<address> \<tier> \<requestedShareLimit> [-f, --fund] | changes the tier of the vault and connects to VaultHub. The optional --fund flag funds the vault with 1 ETH                                                                                                            |
...
| set-node-operator-fee-recipient set-no-f-r\<address> \<recipient>                                | sets the node operator fee recipient address                                                                                                                                                                           |
